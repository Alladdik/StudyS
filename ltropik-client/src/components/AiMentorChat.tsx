      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 w-80 sm:w-96 bg-white dark:bg-[#0e2218] rounded-3xl shadow-2xl dark:shadow-black/50 border border-ink-100 dark:border-[#1c3a2a] flex flex-col z-40 overflow-hidden"
            ...
            <div className="flex items-center gap-3 px-4 py-3.5 bg-gradient-to-r from-brand-600 to-brand-700">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/60 text-xs">Помічник для викладача: ідеї, пояснення, формулювання</p>
              </div>
            ...
            {/* Messages */}
            <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-3 min-h-0 bg-ink-50/50 dark:bg-[#0c1f16]/50">
              {messages.length === 0 && (
                ...
                <motion.div key={i} initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }}
                  ...
                  <div className={`max-w-[85%] px-3.5 py-2.5 rounded-2xl text-sm leading-relaxed ${
                    msg.role === 'user'
                      ...
                      : 'bg-white dark:bg-[#102a1d] text-ink-700 dark:text-[#b0b8d0] rounded-bl-md border border-ink-100 dark:border-[#1c3a2a]'
                  }`}>
                    {msg.text}
                  </div>
                </motion.div>
              ...
              {loading && (
                <div className="flex justify-start">
                  <div className="bg-white dark:bg-[#102a1d] border border-ink-100 dark:border-[#1c3a2a] rounded-2xl rounded-bl-md px-4 py-3 flex gap-1.5">
                    {[0, 1, 2].map((i) => (
            ...
            {/* Input */}
            <div className="border-t border-ink-100 dark:border-[#1c3a2a] p-3 bg-white dark:bg-[#0e2218]">
              {remaining <= 0 ? (
